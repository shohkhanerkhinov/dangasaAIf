...
const stats = [
  { key: "totalVisitors" as const, value: 24800, icon: Eye, color: "#00F5FF" },
  { key: "registeredUsers" as const, value: 8320, icon: Users, color: "#45A29E" },
  { key: "activeUsers" as const, value: 3150, icon: Activity, color: "#00F5FF" },
];
